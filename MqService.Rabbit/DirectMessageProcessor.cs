...
namespace MqService.Rabbit
{
    ...
    {
        public void Publish(IModel channel, string channelName, bool durable, IMessage message, string expiration)
        {
        ...
        public string ListenRabbitMessage(IModel channel, string channelName,  Action<IMessage> callback) 
        {
